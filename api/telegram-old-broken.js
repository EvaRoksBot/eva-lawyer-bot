// Eva Lawyer Bot - Final Working Version with Interactive Menus
// Handles all Telegram webhook requests with proper error handling
...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    return res.status(200).json({
      status: "ok",
      message: "Eva Lawyer Bot Final Working API",
